...
public class MiniJavaTokensTest {
    ...
    void start_text_string_literals_present() {
        assertFalse(match(3, Texts.START_TEXT).isEmpty(), "START_TEXT should contain at least 1 string literal");
    }

    @Test
    void start_text_annotation_present() {
        assertFalse(match(5, Texts.START_TEXT).isEmpty(), "START_TEXT should contain at least 1 annotation");
    }
